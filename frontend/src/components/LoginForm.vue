...
<template id="login-form">
  <div class="login-wrapper">
    <div class="login-left">
      <img width="300" src="../../public/hansol-logo.png">
    </div>
    <form class="login-right" @submit.prevent>
      <div class="h2">Login</div>
      <div class="form-group">
        <input class="rounded pl-1 " type="text" id="username" placeholder="Username" v-model="username">
        <label for="username">Username</label>    
      </div>
      <div class="form-group">
        <input class="rounded pl-1 " type="password" id="Password" placeholder="Password" v-model="password">
